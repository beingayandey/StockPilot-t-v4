// shared compact classnames
export const cls = {
    card: "bg-neutral-100 border border-neutral-300 rounded shadow-sm",
    cardHeader: "p-2 border-b border-neutral-300",
    sectionTitle: "text-[13px] font-semibold text-primary-black",
    body: "p-2 space-y-2",

    label: "block text-xs font-medium text-primary-black mb-1",
